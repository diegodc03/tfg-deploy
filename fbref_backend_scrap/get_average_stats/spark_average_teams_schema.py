...
# Esquema para poner las estadisticas de un equipo de futbol por temporada
# y por liga en la base de datos

from pyspark.sql.types import StructType, StructField, IntegerType, DoubleType, StringType

def get_teams_average_spark_schema():
    ...
    return schema
def get_teams_average_spark_schema_by_positions_gk():
...
def get_teams_average_spark_schema_by_positions_field_player_and_team():
...
ALTER TABLE avg_teams_stats ADD FOREIGN KEY (team_id) REFERENCES team(team_id) ON DELETE CASCADE ON UPDATE CASCADE;
