...
def get_stats_to_offensive_player_and_juego_por_bandas_type_of_centrocampista_ofensivo(match_id, season, specific_position_id):
    print("Comienzo con la adición de puntuación de stats de los jugadores por tipo de juego ofensivo juego por bandas y  mediocentros ofensivos")
...
def get_stats_to_offensive_player_and_juego_por_bandas_type_of_centrocampista_creativo(match_id, season, specific_position_id):
    print("Comienzo con la adición de puntuación de stats de los jugadores por tipo de juego ofensivo juego por bandas y  mediocentros creativo")
...
def get_stats_to_offensive_player_and_juego_por_bandas_type_of_centrocampista_lateral(match_id, season, specific_position_id):
    print("Comienzo con la adición de puntuación de stats de los jugadores por tipo de juego ofensivo juego por bandas y mediocentros lateral")
...
def get_stats_to_offensive_player_and_juego_por_bandas_type_of_delantero_centro(match_id, season, specific_position_id):
    print("Comienzo con la adición de puntuación de stats de los jugadores por tipo de juego ofensivo juego por bandas y delantero centro")
...
def get_stats_to_offensive_player_and_juego_por_bandas_type_of_delantero_extremo(match_id, season, specific_position_id):
    print("Comienzo con la adición de puntuación de stats de los jugadores por tipo de juego ofensivo juego por bandas y   delantero extremo")
