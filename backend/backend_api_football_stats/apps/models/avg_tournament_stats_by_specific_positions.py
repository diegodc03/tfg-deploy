...
class AvgTournamentStatsBySpecificPositions(models.Model):
    ...
    position_player = models.ForeignKey(SpecificsPositionsByCategory, on_delete=models.CASCADE, null=True, blank=True, db_column='position_player')
    ...
    class Meta:
        managed = False
        db_table = 'avg_player_stats_by_specific_positions'